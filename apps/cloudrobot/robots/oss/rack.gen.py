...
def Cmds(OSISObjManipulatorClass):
    ...
    def __init__(self):    
        ...
        self.model=self.osisclient.rack
        self.spec="""
model:
...
- {default: '', descr: '', isdict: false, islist: false, name: label, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: pod, optional: false,
  tags: '', type: str}
...
- {default: '', descr: '', isdict: false, islist: false, name: datacenter_name, optional: false,
  tags: '', type: str}
- {default: '', descr: id of organization which owns the rack if any, isdict: false,
  islist: false, name: organization, optional: false, tags: id of organization which
    owns the rack if any, type: str}
