...
def Cmds(OSISObjManipulatorClass):
    ...
    def __init__(self):    
        ...
        self.model=self.osisclient.group
        self.spec="""
model:
...
- {default: '', descr: '', isdict: false, islist: false, name: name, optional: false,
  tags: '', type: str}
- {default: '', descr: reference to addr, isdict: false, islist: true, name: addresses,
  optional: false, tags: reference to addr, type: str}
- {default: '', descr: users in group (based on ids), isdict: false, islist: true,
  name: members, optional: false, tags: users in group (based on ids), type: str}
- {default: '', descr: '', isdict: false, islist: true, name: members_name, optional: false,
  tags: '', type: str}
