...
def Cmds(OSISObjManipulatorClass):
    ...
    def __init__(self):    
        ...
        self.model=self.osisclient.address
        self.spec="""
model:
- {default: '', descr: '', isdict: false, islist: false, name: id, optional: false,
  tags: '', type: int}
- {default: '', descr: '', isdict: false, islist: false, name: country, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: city, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: citycode, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: zone, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: region, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: street, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: nr, optional: false,
  tags: '', type: int}
- {default: '', descr: '', isdict: false, islist: false, name: floor, optional: false,
  tags: '', type: int}
propname_longest: 8
