...
def Cmds(OSISObjManipulatorClass):
    ...
    def __init__(self):    
        ...
        self.model=self.osisclient.project
        self.spec="""
model:
...
- {default: '', descr: '', isdict: false, islist: false, name: name, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: descr, optional: false,
  tags: '', type: str}
- {default: '', descr: which organizations is proj linked to, isdict: false, islist: true,
  name: organizations, optional: false, tags: which organizations is proj linked to,
  type: str}
