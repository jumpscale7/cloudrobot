...
def Cmds(OSISObjManipulatorClass):
    ...
    def __init__(self):    
        ...
        self.model=self.osisclient.datacenter
        self.spec="""
model:
...
- {default: '', descr: '', isdict: false, islist: false, name: label, optional: false,
  tags: '', type: str}
- {default: '', descr: id of organization which owns dc, isdict: false, islist: false,
  name: organization, optional: false, tags: id of organization which owns dc, type: str}
