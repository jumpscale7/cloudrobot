...
def Cmds(OSISObjManipulatorClass):
    ...
    def __init__(self):    
        ...
        self.model=self.osisclient.machine
        self.spec="""
model:
...
- {default: '', descr: '', isdict: false, islist: false, name: name, optional: false,
  tags: '', type: str}
- {default: '', descr: id of organization which owns the machine if any, isdict: false,
  islist: false, name: organization, optional: false, tags: id of organization which
    owns the machine if any, type: str}
...
- {default: '', descr: '', isdict: false, islist: true, name: interfaces, optional: false,
  tags: '', type: str}
- {default: '', descr: ' link to other machines (what does it need to work)', isdict: false,
  islist: true, name: depends, optional: false, tags: ' link to other machines (what
    does it need to work)', type: str}
- {default: '', descr: '', isdict: false, islist: true, name: depends_names, optional: false,
  tags: '', type: str}
- {default: '', descr: who is asset hosting this machinehost, isdict: false, islist: false,
  name: assethost, optional: false, tags: who is asset hosting this machinehost, type: int}
...
- {default: '', descr: '', isdict: false, islist: false, name: nrcpu, optional: false,
  tags: '', type: int}
- {default: '', descr: encrypted root passwd, isdict: false, islist: false, name: rootpasswd,
