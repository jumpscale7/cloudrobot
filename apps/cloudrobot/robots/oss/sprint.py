...
def Cmds(OSISObjManipulatorClass):
    ...
    def __init__(self):    
        ...
        self.model=self.osisclient.sprint
        self.spec="""
model:
...
- {default: '', descr: '', isdict: false, islist: false, name: description, optional: false,
  tags: '', type: str}
- {default: '', descr: epoch, isdict: false, islist: false, name: start, optional: false,
  tags: epoch, type: int}
- {default: '', descr: epoch, isdict: false, islist: false, name: stop, optional: false,
  tags: epoch, type: int}
- {default: '', descr: organizations involved with this sprint, isdict: false, islist: true,
  name: organizations, optional: false, tags: organizations involved with this sprint,
  type: str}
- {default: '', descr: comma separated list of names of orgs, isdict: false, islist: false,
  name: organizations_names, optional: false, tags: comma separated list of names
    of orgs, type: str}
