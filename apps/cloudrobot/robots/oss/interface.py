...
def Cmds(OSISObjManipulatorClass):
    ...
    def __init__(self):    
        ...
        self.model=self.osisclient.interface
        self.spec="""
model:
- {default: '', descr: '', isdict: false, islist: false, name: type, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: macaddr, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: vlanid, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: vxlanid, optional: false,
  tags: '', type: str}
- {default: '', descr: id of organization which owns the ipaddr if any, isdict: false,
  islist: false, name: organization, optional: false, tags: id of organization which
    owns the ipaddr if any, type: str}
- {default: '', descr: '', isdict: false, islist: true, name: netaddr, optional: false,
  tags: '', type: str}
- {default: '', descr: ' link to other interfaces', isdict: false, islist: true, name: connects,
  optional: false, tags: ' link to other interfaces', type: str}
