...
- create (c,n,new)
-- id
-- parent       #parent doc (where this document is a version of)
-- name
-- creationdate
-- moddate
-- type         # SPREADSHEET:DOC:TXT:CODE:...
-- ext          # e.g. docx;xls;...
-- contents     #full text content
-- objstorid    #reference on doc mgmt system (stored in sort of key value obj store)
-- description
