...
-- id
-- name
-- organization      #id of organization which owns the service if any
-- organization_name
-- label
-- parent
-- parent_name
...
-- type
-- serviceports
-- depends           # link to other services (what does it need to work)
-- depends_names
-- machinehost       #who is machine hosting this service
-- memory            #in GB
-- ssdcapacity       #in GB
-- hdcapacity        #in GB
-- cpumhz            #in mhz
-- nrcores
-- nrcpu
-- admin_name        #name of admin e.g. admin or root
-- admin_passwd      #encrypted root passwd
