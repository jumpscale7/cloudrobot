...
def Cmds(OSISObjManipulatorClass):
    ...
    def __init__(self):    
        ...
        self.model=self.osisclient.serviceport
        self.spec="""
model:
- {default: '', descr: '', isdict: false, islist: false, name: id, optional: false,
  tags: '', type: int}
- {default: '', descr: '', isdict: false, islist: false, name: serviceid, optional: false,
  tags: '', type: int}
...
- {default: '', descr: '', isdict: false, islist: false, name: ipaddr6, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: url, optional: false,
  tags: '', type: str}
- {default: '', descr: '', isdict: false, islist: false, name: port, optional: false,
  tags: '', type: str}
