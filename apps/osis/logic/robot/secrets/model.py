...
from robot_secrets_osismodelbase import robot_secrets_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class robot_secrets(OsisBaseObject,robot_secrets_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        robot_secrets_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
