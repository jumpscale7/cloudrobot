...
from robot_ace_osismodelbase import robot_ace_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class robot_ace(OsisBaseObject,robot_ace_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        robot_ace_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
