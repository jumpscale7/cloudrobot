...
from robot_provider_osismodelbase import robot_provider_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class robot_provider(OsisBaseObject,robot_provider_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        robot_provider_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
