...
from robot_template_osismodelbase import robot_template_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class robot_template(OsisBaseObject,robot_template_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        robot_template_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
