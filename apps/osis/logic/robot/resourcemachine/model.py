...
from robot_resourcemachine_osismodelbase import robot_resourcemachine_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class robot_resourcemachine(OsisBaseObject,robot_resourcemachine_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        robot_resourcemachine_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
