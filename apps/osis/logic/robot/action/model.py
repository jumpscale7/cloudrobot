...
from robot_action_osismodelbase import robot_action_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class robot_action(OsisBaseObject,robot_action_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        robot_action_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
