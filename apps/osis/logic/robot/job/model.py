...
from robot_job_osismodelbase import robot_job_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class robot_job(OsisBaseObject,robot_job_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        robot_job_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
