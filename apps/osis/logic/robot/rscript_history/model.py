...
from robot_rscript_history_osismodelbase import robot_rscript_history_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class robot_rscript_history(OsisBaseObject,robot_rscript_history_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        robot_rscript_history_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
