...
from robot_rscript_osismodelbase import robot_rscript_osismodelbase

#this class is meant to be overrided e.g. the getuniquekey, ...

class robot_rscript(OsisBaseObject,robot_rscript_osismodelbase):
    ...
    def __init__(self, ddict={}):
        ...
        robot_rscript_osismodelbase.__init__(self)
        if ddict <> {}:
            self.load(ddict)
